...
void loop ()
{
    ...
    cubeFrame* f[] = {
        ...
        cube.createFrame((const byte[]) {2,1, 2,6}, 4, 108),
        cube.createFrame((const byte[]) {1,1, 1,6}, 4, 108),
        cube.createFrame((const byte[]) {0,1, 0,6}, 4, 108),
        cube.createFrame((const byte[]) {1,3, 2,8}, 4, 108),
        cube.createFrame((const byte[]) {0,3, 1,5}, 4, 108),
        cube.createFrame((const byte[]) {0,5}, 2, 108),
        cube.createFrame((const byte[]) {2,1, 2,6, 2,8}, 6, 108),
        cube.createFrame((const byte[]) {1,1, 1,6, 1,8}, 6, 108),
        cube.createFrame((const byte[]) {0,1, 0,6, 0,8}, 6, 108),
        cube.createFrame((const byte[]) {}, 0, 108),

         cube.createFrame((const byte[]) {0,1, 0,4, 0,7, 1,0, 1,2, 1,3, 1,5, 1,6, 1,8}, 18, 120),
        cube.createFrame((const byte[]) {1,0, 1,2, 1,3, 1,5, 1,6, 1,8, 2,1, 2,4, 2,7}, 18, 108),
        cube.createFrame((const byte[]) {1,1, 1,4, 1,7, 2,0, 2,2, 2,3, 2,5, 2,6, 2,8}, 18, 108),
        cube.createFrame((const byte[]) {2,0, 2,1, 2,2, 2,3, 2,4, 2,5, 2,6, 2,7, 2,8}, 18, 108),
        cube.createFrame((const byte[]) {1,0, 1,2, 1,3, 1,5, 1,6, 1,8}, 12, 108),
        cube.createFrame((const byte[]) {0,1, 0,4, 0,7, 1,0, 1,2, 1,3, 1,5, 1,6, 1,8}, 18, 108),
        cube.createFrame((const byte[]) {0,0, 0,2, 0,3, 0,5, 0,6, 0,8, 1,1, 1,4, 1,7}, 18, 108),
